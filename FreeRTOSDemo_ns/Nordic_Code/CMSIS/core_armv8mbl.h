...
typedef union
{
  struct
  {
    uint32_t _reserved0:28;              //Reserved
...
typedef union
{
  struct
  {
    ...
    uint32_t _reserved0:23;              //Reserved
  } b;                                   /*!< Structure used for bit  access */
  uint32_t w;                            /*!< Type      used for word access */
} IPSR_Type;
...
typedef union
{
  ...
  {
    uint32_t ISR:9;                      /*!< bit:  0.. 8  Exception number */
    uint32_t _reserved0:15;              //Reserved
...
typedef union
{
  struct
  {
    ...
    uint32_t _reserved1:30;              //Reserved
  } b;                                   /*!< Structure used for bit  access */
  uint32_t w;                            /*!< Type      used for word access */
} CONTROL_Type;
...
typedef struct
{
  ...
  __IOM uint32_t CCR;                    /*!< Offset: 0x014 (R/W)  Configuration Control Register */
        uint32_t RESERVED1;
  __IOM uint32_t SHPR[2U];               //Reserved
