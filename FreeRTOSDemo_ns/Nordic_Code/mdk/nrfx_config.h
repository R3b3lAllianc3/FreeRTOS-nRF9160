/*MQ Added to enable nrf_drv_clock_*() functions. */
 ...
 */
 /* MQ Non-secure access actually granted by SPU as specified in tzm_config.c in the secure code. */
#define NRF_CLOCK      NRF_CLOCK_NS /* MQ  NRF_CLOCK redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_DPPIC      NRF_DPPIC_NS /* MQ  NRF_DPPIC redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_EGU0       NRF_EGU0_S
#define NRF_EGU1       NRF_EGU1_S /* MQ  NRF_EGU1 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_EGU2       NRF_EGU2_S /* MQ  NRF_EGU2 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_EGU3       NRF_EGU3_S
#define NRF_EGU4       NRF_EGU4_S
#define NRF_EGU5       NRF_EGU5_S
#define NRF_FPU        NRF_FPU_NS /* MQ  NRF_FPU redefined for non-secure base address as it's going to be accessed from NS code. */

#define NRF_P0         NRF_P0_NS /* MQ  NRF_P0 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_I2S        NRF_I2S_S
#define NRF_IPC        NRF_IPC_NS /* MQ  NRF_IPC redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_KMU        NRF_KMU_S
#define NRF_NVMC       NRF_NVMC_NS /* MQ  NRF_NVMC redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_PDM        NRF_PDM_S
#define NRF_POWER      NRF_POWER_NS /* MQ  NRF_POWER redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_PWM0       NRF_PWM0_NS /* MQ  NRF_PWM0 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_PWM1       NRF_PWM1_NS /* MQ  NRF_PWM1 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_PWM2       NRF_PWM2_NS /* MQ  NRF_PWM2 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_PWM3       NRF_PWM3_NS /* MQ  NRF_PWM3 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_REGULATORS NRF_REGULATORS_NS /* MQ  NRF_REGULATORS redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_RTC0       NRF_RTC0_NS /* MQ  NRF_RTC0 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_RTC1       NRF_RTC1_NS /* MQ  NRF_RTC1 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_SAADC      NRF_SAADC_NS /* MQ  NRF_SAADC redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_SPIM0      NRF_SPIM0_S
#define NRF_SPIM1      NRF_SPIM1_S
#define NRF_SPIM2      NRF_SPIM2_S
#define NRF_SPIM3      NRF_SPIM3_NS /* MQ  NRF_SPIM3 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_SPIS0      NRF_SPIS0_S
#define NRF_SPIS1      NRF_SPIS1_S
#define NRF_SPIS2      NRF_SPIS2_S
#define NRF_SPIS3      NRF_SPIS3_S
#define NRF_TIMER0     NRF_TIMER0_NS /* MQ  NRF_TIMER0 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_TIMER1     NRF_TIMER1_NS /* MQ  NRF_TIMER1 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_TIMER2     NRF_TIMER2_NS /* MQ  NRF_TIMER2 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_TWIM0      NRF_TWIM0_S
#define NRF_TWIM1      NRF_TWIM1_S
#define NRF_TWIM2      NRF_TWIM2_NS /* MQ  NRF_TWIM2 redefined for non-secure base address as it's going to be accessed from NS code. */
...
#define NRF_UARTE0     NRF_UARTE0_NS /* MQ  NRF_UARTE0 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_UARTE1     NRF_UARTE1_NS /* MQ  NRF_UARTE1 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_UARTE2     NRF_UARTE2_NS /* MQ  NRF_UARTE2 redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_UARTE3     NRF_UARTE3_S
#define NRF_VMC        NRF_VMC_NS /* MQ  NRF_VMC redefined for non-secure base address as it's going to be accessed from NS code. */
#define NRF_WDT        NRF_WDT_NS /* MQ  NRF_WDT redefined for non-secure base address as it's going to be accessed from NS code. */
